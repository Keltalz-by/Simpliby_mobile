...
class _BuyerHomeScreenState extends State<BuyerHomeScreen> {
  ...
  late StoresAndMallsController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<StoresAndMallsController>();
        ...
        children: [
          ...
          Container(
            ...
            child: Obx(() {
              return RichText(
                text: TextSpan(
                  text: controller.state is s.ErrorState ? "" : "View all",
                  style: TextStyle(
                    color: blackColor,
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTap = () {
                      controller.state is s.ErrorState
                          ? VoidCallback
  ...
  Widget _toBuyList(BuildContext context) {
    return Obx(() {
      if (controller.stateToBuy is s.LoadingState) {
        return const Text("Loading...");
      }
      if (controller.stateToBuy is s.FinishedState) {
  ...
  Widget _itemsList(BuildContext context) {
    return Obx(() {
      if (controller.state is s.LoadingState) {
        return defaultLoading(context);
      }
      if (controller.state == s.ErrorState(errorType: InternetError())) {
        return noInternet(() {
          controller.reload();
        });
      }
